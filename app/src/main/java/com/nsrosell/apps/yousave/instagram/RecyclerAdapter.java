...
import com.nsrosell.apps.yousave.View.MyImageView;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
    ...
    private void setupChannels(NotificationManager notificationManager) {
        ...
        adminChannel = new NotificationChannel("com.nsrosell.media_toolbox", adminChannelName, NotificationManager.IMPORTANCE_DEFAULT);
