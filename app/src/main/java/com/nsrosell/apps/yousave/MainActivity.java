...
import com.nsrosell.apps.yousave.whatsApp.util.PermissionUtil;
...
public class MainActivity extends AppCompatActivity {
        ...
        if(Intent.ACTION_SEND.equals(action) && type!=null){
            if(type.equals("text/plain")){
                ...
                if(intentData.contains("://youtu.be/")||intentData.contains("youtube.com/watch?v=")){
                        ...
                        startActivity(new Intent(this, com.nsrosell.apps.yousave.youtube.MainActivity.class)
                    ...
                    startActivity(new Intent(this, com.nsrosell.apps.yousave.instagram.MainActivity.class)
                            .putExtra("url",intentData));
                    finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SharedPreferences sharedPref=getSharedPreferences("YouSave",MODE_PRIVATE);
    ...
    public void openWhatsapp(View view) {
        startActivity(new Intent(this, com.nsrosell.apps.yousave.whatsApp.ui.main.MainActivity.class));
    }
