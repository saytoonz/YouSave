...
import com.nsrosell.apps.yousave.whatsApp.ui.base.BaseFragment;
import com.nsrosell.apps.yousave.whatsApp.ui.imageslider.ImageSliderActivity;
import com.nsrosell.apps.yousave.whatsApp.util.DialogFactory;
...
import static com.nsrosell.apps.yousave.whatsApp.ui.imageslider.ImageSliderActivity.IMAGES_TYPE_RECENT;
import static com.nsrosell.apps.yousave.whatsApp.ui.imageslider.ImageSliderActivity.IMAGES_TYPE_SAVED;
...
public class ImageDetailsFragment extends BaseFragment implements ImageDetailsView {
    ...
    public void displayImageSavedMsg() {
        Snackbar.make(rootView, "Status saved", Snackbar.LENGTH_SHORT).show();
    }

    @Override
    public void displayDeleteSuccessMsg() {
        Snackbar.make(rootView, "Status removed from saved items", Snackbar.LENGTH_SHORT).show();
    }
